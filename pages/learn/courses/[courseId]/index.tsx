...
export default function CourseDetailPage({ params }: { params?: { courseId?: string } }) {
    ...
    useEffect(() => {
        ...
        // Récupération du courseId soit depuis params, soit depuis router.query
        const courseId = params?.courseId || (Array.isArray(router.query.courseId) ? router.query.courseId[0] : router.query.courseId);
        if (!courseId) {
        ...
        fetchCourse();
    }, [router.isReady, router.query.courseId, params]);
